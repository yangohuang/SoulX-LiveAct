...
OUTPUT = Path('/tmp/liveact-profile-pinned-224x384')
...
sys.argv = [
    ...
    '--fps', '24',
    '--input_json', '/tmp/liveact-profile-pinned-224x384-1p5s.json',
    '--fp8_cache_dir', '/tmp/liveact-fp8-cache',
    '--prompt_cache_dir', '/tmp/liveact-prompt-cache',
    '--resident_kv_steps', '1',
    '--fp8_gemm', '--fp8_kv_cache', '--offload_cache',
    '--block_offload', '--pin_block_memory', '--t5_cpu', '--disable_compile', '--dura_print',
]
